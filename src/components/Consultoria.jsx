  ...
  return (
    <div className="w-full h-full" id="consultoria">
      <div className="container margin-lateral m-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-5 items-center justify-between">
          <div>
            <p className="">
              Levamos conteúdos específicos a cada perfil de família de forma
              que possam se reeducar e criar de forma respeitosa crianças e
