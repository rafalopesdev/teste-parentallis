        ...
        <div className="grid lg:grid-cols-3 gap-5">
          <div className="relative bg rounded-lg p-5 bg-[#69688C]">
            ...
            <p className="text-center text-white">
              Levar saúde emocional às pessoas através da ampliação da visão
              sobre parentalidade consciente. Acreditamos no ser humano de forma
          ...
          <div className="w-full relative h-full bg rounded-lg p-5 bg-[#69688C]">
            ...
            <p className="text-center text-white">
              Democratizar as informações sobre parentalidade consciente para
              que os adultos cuidadores possam contribuir com a formação de uma
              nova e verdadeira geração mais saudável emocionalmente.
            </p>
            <div className=" w-full flex flex-row right-0 justify-center  bottom-0">
              <a href="" className="btn-produtos">
                Saiba Mais
